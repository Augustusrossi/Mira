...
<body>
	...
	<main class="main row main-pub">

		<section class="form-tudo form-post">
			<div class="divs-forms">
					
				<form action="MiraController" method="post" class="form form-cadastro form-publi" enctype="multipart/form-data">
	
					<input type="text" name="descricao" id="descricao" required class="formInputs" placeholder="Legenda do meu Post aqui:"> 
