...
<body>
	...
	<c:if test="${erro}">
		<span id="verificaLogin" style="display:none;">erro</span>
	</c:if>
		...
		<section class="form-tudo">
			<div class="div-esquerda divs-forms">
				...
				<button onclick="window.location.href='cadastro.jsp'"
					value="Criar Conta" class="full-button">Criar Conta</button>
			...
			<div class="div-direita divs-forms">
				...
				<h2>Login</h2>
				<form action="MiraController" method="post" class="form">

					<div class="formInputs">
						<input type="text" name="usuario" id="usuarioId"
							placeholder="Usuário"> <input type="password"
							name="senha" id="senhaId" placeholder="Senha">
					</div>

					<button type="submit" value="logar" name="operacao" id="entrarId"
						class="full-button">Entrar</button>
	...
	<script>
		...
		let loginValido = document.getElementById("verificaLogin");
	
		if(loginValido && loginValido.innerText.trim() === "erro"){
